...
{ 
    /// <summary>
    /// A forward contract is a customized contract between two parties to buy or sell currencies at a specified price on a future date.
    /// </summary>
    [DataContract]
    public partial class FxForward : IEquatable<FxForward>
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FxForward)obj);
        }

        /// <summary>
        /// Returns true if FxForward instances are equal
        /// </summary>
        /// <param name="other">Instance of FxForward to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FxForward other)
        {
        ...
        public static bool operator ==(FxForward left, FxForward right)
        {
