...
{ 
    /// <summary>
    /// Base schema for a financial instrument.
    /// </summary>
    [DataContract]
    public partial class FinancialInstrumentBase : IEquatable<FinancialInstrumentBase>
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FinancialInstrumentBase {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FinancialInstrumentBase)obj);
        }

        /// <summary>
        /// Returns true if FinancialInstrumentBase instances are equal
        /// </summary>
        /// <param name="other">Instance of FinancialInstrumentBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FinancialInstrumentBase other)
        {
        ...
        public static bool operator ==(FinancialInstrumentBase left, FinancialInstrumentBase right)
        {
