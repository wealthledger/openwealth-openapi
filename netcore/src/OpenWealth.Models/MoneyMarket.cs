...
{ 
    /// <summary>
    /// The money market schema covers both fixed and callable loans and deposits.
    /// </summary>
    [DataContract]
    public partial class MoneyMarket : IEquatable<MoneyMarket>
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((MoneyMarket)obj);
        }

        /// <summary>
        /// Returns true if MoneyMarket instances are equal
        /// </summary>
        /// <param name="other">Instance of MoneyMarket to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MoneyMarket other)
        {
        ...
        public static bool operator ==(MoneyMarket left, MoneyMarket right)
        {
